...
/**
 *
 * In this version, I delete the distance comparison, i.e., no SIFT descriptor information in the input files.
 *
 * Created by HarryC on 1/7/15.
 */
public class TMCRawTest {
    ...
    public static void main(String args[]) {
        ...
        CashIndex3 cashIndex3 = new CashIndex3(limit * L, L);
            ...
            if (operationType == Constant.OPERATION_QUERY) {
                ...
                if (!queryFileListLoaded) {
                    ...
                    while (true) {
                        ...
                        List<LSHVector> qf = loadQueryLshVectors(queryFileList.get(queryIndex - 1), L);
